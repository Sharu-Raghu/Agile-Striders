...
import com.example.sharanya.MyPassbook.DashboardActivity;
import com.example.sharanya.MyPassbook.R;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private TextView registerLink, tvReset;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      auth = FirebaseAuth.getInstance();
        ...
        tvReset = (TextView) findViewById(R.id.tvForgot);
